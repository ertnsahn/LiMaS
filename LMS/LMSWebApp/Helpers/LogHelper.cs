...
namespace LMSWebApp.Helpers
{
    public class LogHelper
    {
        ...
        public void LogError(System.Exception exception, MethodBase methodBase)
        {
            ...
            {
                ErrorDetailsMessage = msg.ToString()
            });
        ...
        private static string DbException(DbUpdateException pDbUpdateException,MethodBase pMethodBase)
        {
            ...
            {
                SqlException updateException = (SqlException)pDbUpdateException.InnerException;
